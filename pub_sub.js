...
async function start() {
    ...
    app.post('/send-otp', async (req, res) => {
        ...
        await redisClient.publish('send-otp', JSON.stringify({ data: {req, otp } }));
        // Set up a subscriber to listen for messages
        // subscriber should listen for messages on "chat-channel" and run individual email sending logic so write in another file pub_sub.js
